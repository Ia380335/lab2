...
HD_PWD='C:/Users/dishan/CSUN_Parking_Pay_Station/CSUN_Parking_Pay_Station.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CSUN_Parking_Pay_Station.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CSUN_Parking_Pay_Station.tcl
